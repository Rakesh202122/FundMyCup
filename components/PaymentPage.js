  ...
  const pay = async (amount) => {
    try {
      ...
      var options = {
        ...
        currency: "INR",
        name: "FundMyCup", // your business name
...
<ToastContainer />
      ...
      <div className="cover w-full bg-red-50 relative">
        <img className="object-cover w-full h-48 md:h-[150] shadow-blue-700 shadow-sm" src={currentUser.coverpic} alt="" />
        <div className="absolute bottom-1 right-[30%] md:right-[44%] border-white overflow-hidden border-2 rounded-full size-36">
          ...
          <div className="supporters w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
            ...
            <ul className="mx-5 text-lg">
              ...
              return <li key={i} className="my-4 flex gap-2 items-center">
                <img width={44} src="man.gif" alt="user avatar" />
                <span>
                  {p.name} donated <span className="font-bold">₹{p.amount/100}</span> with a
                  message {p.message}. With Lots of 🩷
                </span>
              </li>
              })}
            </ul>
          ...
          <div className="makePayment w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
            ...
            <div className="flex gap-2 flex-col">
              ...
              <button
                ...
                className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 disabled: bg-slate-600 disabled:from-purple-100"
